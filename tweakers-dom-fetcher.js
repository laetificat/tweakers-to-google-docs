...
function handleMessage(request, sender, sendResponse) {
	var productData = [];
	productData['title'] = document.getElementById("entity").getElementsByTagName("header")[0].getElementsByTagName("h1")[0].getElementsByTagName("a")[0].innerText
	productData['price'] = document.getElementById("listing").getElementsByTagName("tbody")[0].firstElementChild.getElementsByClassName("shop-price")[0].innerText;
